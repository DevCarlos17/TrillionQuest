    ...
    <div className="min-h-screen w-[100vw] mx-auto">
      ...
      <div className="flex flex-col md:flex-row justify-center gap-8 sm:gap-32 mb-10">
        ...
        <div className="flex sm:flex-col items-center justify-center text-center ">
          ...
          />
          <div>
            <span className="flex md:flex md:text-2xl font-bold">
              User Experience <br className="hidden sm:inline" /> (UX/UI){' '}
            </span>
        ...
        <div className="flex sm:flex-col items-center justify-center text-center">
          ...
          <div>
            ...
            <span className="md:text-1xl font-bold mt-2 text-gray-400">
              We design personalized <br /> strategies for your <br />{' '}
              brand&apos;s success.
            </span>
          </div>
          <Image
      ...
      <div class="flex flex-col items-center justify-center md:h-[40vh] text-white">
        ...
        <button
          class="border-2 text-2xl md:text-4xl 
                    transition transform duration-700 border-white
                    text-black bg-yellow-500 font-bold rounded-full 
                    px-5 md:px-10 py-5 md:py-5 hover:scale-125"
        >
          Contact Us
        </button>
      </div>
