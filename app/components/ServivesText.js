...
export default function ServicesText() {
    return (
        <div className="flex flex-col w-auto">
            <span className="text-6xl font-bold text-yellow-500 ml-14 md:mt-40 mb-2">
                Services
            </span>
            <span className="text-3xl font-bold text-white ml-14">
                Ready to elevate your brand? Let’s make it happen!
            </span>

            <div className="flex md:ml-14 mt-10 mb-10">
                <Button
                    name="Book a Call"
            ...
            <div className="ml-14 text-white text-2xl font-bold">
